"""
src/databaseCreator.py
~~~~~~~~~~~~~~~~~~~~~~
Downloads the relevant PI blueprint data from the EVE SDE (Static Data Export)
and builds a local SQLite database with three tables:
